...
function App() {
 ...
 // const [error, setError] = useState();
  ...
  async function handleSelectPlace(selectedPlace) {
    ...
    try {
      console.log("handleSelectPlace", [selectedPlace, ...userPlaces]);
      ...
      console.log("handleSelectPlace catch");
    }
